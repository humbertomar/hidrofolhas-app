...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__registration__ = __webpack_require__(741);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_fire_database__ = __webpack_require__(94);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RegistrationPage = /** @class */ (function () {
    ...
    RegistrationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-registration",template:/*ion-inline-start:"E:\000-KOISAS-DS\trabalhos\hidrofolhas\appHidrofolhas\src\pages\registration\registration.html"*/'<ion-content padding class="transparent-header" [ngStyle]="{\'background-image\': \'url(\' + backgroundImage +\')\'}">\n\n    <div padding>\n\n        <form [formGroup]="registration" (ngSubmit)="onSubmit()">\n        \n            <ion-row>\n                <ion-col>\n        \n                    <ion-list inset class="no-border">\n        \n                        <img class="logo" src="assets/img/logo-2.png" />\n        \n                        <ion-item>\n                            <ion-input type="email" name="email" placeholder="Digite seu e-mail" id="email"\n                                formControlName="email" required></ion-input>\n                        </ion-item>\n\n                        <br>\n        \n                        <ion-item>\n                            <ion-input type="password" name="password" placeholder="Digite uma senha" id="password"\n                                formControlName="password" required></ion-input>\n                        </ion-item>\n\n                        <br>\n\n                        <button class="login-btn" type="submit" [disabled]="!registration.valid" ion-button>Criar Conta</button>\n        \n                    </ion-list>\n        \n                </ion-col>\n            </ion-row>\n\n            <ion-row>\n                <ion-col>\n                    <a style="font-size: 14px; text-align: center;" ion-text color="light" (click)="navLogin()">Já tem conta? Clique aqui para acessar!</a>\n                </ion-col>\n            </ion-row>\n            \n        </form>\n\n        <!--<br>\n\n        <ion-row>\n            <ion-col col-12 text-center>\n                <button (click)="navLogin()" ion-button small color="energy">ENTRAR</button>\n            </ion-col>\n            <ion-col col-12 text-center>\n                <button (click)="back()" ion-button small color="dark">VOLTAR</button>\n            </ion-col>\n        </ion-row>-->\n\n    </div>\n</ion-content>'/*ion-inline-end:"E:\000-KOISAS-DS\trabalhos\hidrofolhas\appHidrofolhas\src\pages\registration\registration.html"*/,
        }),
